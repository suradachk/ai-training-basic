...
export default function TeacherView({ fontSizes }) {
  ...
  const currentTopic =
    TOPICS_DETAIL.find((t) => t.id === currentTopicId) || TOPICS_DETAIL[0];
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#131b2e] p-2 rounded-2xl border border-slate-800">
            ...
            <div className="text-xs text-slate-400">
              💡 สลับสไลด์: ใช้ปุ่ม{" "}
              <kbd className="px-1.5 py-0.5 bg-slate-800 rounded border border-slate-700 text-slate-200">
                ลูกศรซ้าย/ขวา
              </kbd>{" "}
              หรือ{" "}
              <kbd className="px-1.5 py-0.5 bg-slate-800 rounded border border-slate-700 text-slate-200">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 pb-3 mb-5">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h2
                          className={`${fontSizes.heading} font-bold text-white`}>
                          {currentTopic.title}
                        </h2>
                    ...
                    {currentTopic.subtopics.map((sub, i) => (
                      <div
                        ...
                        <div className="space-y-2">
                          ...
                          <p
                            className={`${fontSizes.base} text-slate-300 leading-relaxed whitespace-pre-line`}>
                            {sub.desc}
                          </p>
                          {sub.example && (
                  ...
                  <button
                    onClick={() =>
                      setCurrentTopicId((prev) =>
                        Math.min(TOPICS_DETAIL.length, prev + 1),
                      )
                    }
            ...
            <div className="minimal-card rounded-2xl p-6 lg:p-8 space-y-6">
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-white">
                  🎤 บทพูดชวนคุยสร้างบรรยากาศ
                </h3>
                <p className="text-xs text-slate-400">
                  สำหรับผู้สอนใช้พูดเปิดใจสร้างบรรยากาศสบายๆ
                  ให้ทุกคนพร้อมเรียนรู้
                </p>
              </div>

              <div className="minimal-card-inner p-4 rounded-xl space-y-2">
                <span className="text-xs font-mono text-slate-400 uppercase tracking-wider block">
                  1. ทักทาย & ปลดล็อกความกลัว
                </span>
                <p className="text-base font-semibold text-white">
                  "สวัสดีทุกคนครับ! วันนี้เรามาเรียน AI แบบสบายๆ สไตล์ครอบครัว
                  ไม่มีสอบ ไม่มีเกรด ไม่ต้องเครียดเลยครับ"
                </p>
                <p className="text-sm text-slate-300">
                  "วันนี้ใครอยากจิบน้ำ ทานขนม หรือลุกขยับตัว
                  ทำตัวตามสบายได้เต็มที่เหมือนนั่งเล่นอยู่ในบ้านเลยครับ"
                </p>
              </div>
              ...
              <div className="minimal-card-inner p-5 rounded-xl text-center space-y-2 border border-slate-700">
                ...
                <p className="text-xs text-slate-400">
                  (หุ่นยนต์? สิริในมือถือ? แชทบอท? → ถูกทุกข้อเลยครับ!)
                </p>
              </div>
              ...
              <div className="minimal-card-inner p-4 rounded-xl space-y-2">
                ...
                <div className="p-3 bg-slate-900 rounded-lg text-sky-200 text-sm">
                  💡 "เปรียบง่ายๆ AI วันนี้เหมือน{" "}
                  <strong>'เด็กฝึกงานอัจฉริยะ'</strong> ที่อ่านหนังสือมาทั้งโลก
                  รู้แทบทุกเรื่อง ทั้งสูตรอาหาร การบ้าน และการเขียนโค้ด...
                  เพียงแต่เขาต้องการ <strong>'พวกเรา'</strong>{" "}
                  เป็นหัวหน้าคอยสั่งงาน"
                </div>
                <p className="text-sm text-slate-300">
                  "ไม่ต้องเขียนโค้ดเป็น พิมพ์ภาษาไทยคุยกับมันเหมือนคุย LINE
                  กับเพื่อน วันนี้ทุกคนจะค่อยๆ ไต่บันได 5 ระดับ AI
                  ไปด้วยกันครับ!"
                </p>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
                    {topic.subtopics.map((sub, idx) => (
                      <div
                        key={idx}
                        className="minimal-card-inner p-3.5 rounded-xl space-y-1.5">
          ...
          {session2Tab === "tutor" && (
            <div className="minimal-card rounded-2xl p-6 space-y-6">
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-white">
                  👨‍🏫 คู่มือคนติว & เทคนิคการสอน
                </h3>
                <p className="text-xs text-slate-400">
                  เทคนิคดูแลผู้เรียนทีละระดับ พร้อมแนวทางช่วยแก้ปัญหา
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="minimal-card-inner p-4 rounded-xl space-y-2">
                  <h4 className="text-sm font-bold text-white">
                    1. ลำดับการพาผู้เรียนไต่บันได 5 ระดับ
                  </h4>
                  <ul className="text-xs text-slate-300 space-y-1.5 list-disc list-inside">
                    <li>
                      <strong>Level 1:</strong>{" "}
                      เริ่มจากให้ลองพิมพ์ถามเรื่องใกล้ตัว เช่น สูตรอาหาร เที่ยว
                    </li>
                    <li>
                      <strong>Level 2:</strong> พาประกอบ Prompt สูตร RTCF
                      เพื่อเห็นความต่างของคำตอบ
                    </li>
                    <li>
                      <strong>Level 3:</strong> โชว์การสร้าง Custom Assistant
                      จำนิสัยส่วนตัว
                    </li>
                    <li>
                      <strong>Level 4:</strong> พาลงมือสร้างไฟล์ index.html
                      เปิดหน้าเว็บเล่นสดๆ
                    </li>
                    <li>
                      <strong>Level 5:</strong> สาธิต AI Agent (Antigravity)
                      สั่งแก้โค้ดอัตโนมัติ
                    </li>
                  </ul>
                </div>
                ...
                <div className="minimal-card-inner p-4 rounded-xl space-y-2">
                  <h4 className="text-sm font-bold text-white">
                    2. วิธีช่วยเมื่อผู้เรียนติดขัด
                  </h4>
                  <ul className="text-xs text-slate-300 space-y-1.5 list-disc list-inside">
                    <li>สอนกด F12 &gt; Console &gt; ก๊อปสีแดงส่ง AI ซ่อมให้</li>
                    <li>
                      บันทึกไฟล์เป็น `index.html` เท่านั้น ระวังอย่าเซฟเป็น
                      `.txt`
                    </li>
                    <li>สั่ง AI: "รวมทุกอย่างใน index.html ไฟล์เดียว"</li>
                    <li>
                      ชื่นชมและให้กำลังใจเมื่อเปิดหน้าเว็บแรกขึ้นมาได้สำเร็จ
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="minimal-card-inner p-4 rounded-xl space-y-2 border border-slate-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                  <label className="flex items-center space-x-2">
                    ...
                    />
                    <span className="text-slate-300">
                      ต่อ Wi-Fi และเปิดเบราว์เซอร์พร้อม
                    </span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input
                    ...
                    />
                    <span className="text-slate-300">
                      เปิดหน้าเว็บสไลด์ฉายขึ้นจอทีวี/โปรเจกเตอร์
                    </span>
                  </label>
                </div>
              </div>
